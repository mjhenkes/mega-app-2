...
// const MyDay = React.lazy(loadComponent('http://localhost:8081/OrganizerPages.js', 'organizer', './PatientSearch'));
// const PatientSearch = React.lazy(() => import('organizer/PatientSearch'));
// const PatientSearch = React.lazy(loadComponent('http://localhost:8081/OrganizerPages.js', 'organizer', './PatientSearch'));
...
// export default {
//   MyDay,
//   PatientSearch: TemplatePage,
//   ChartReview: PatientSearch,
//   Handoff: TemplatePage,
//   ActiveOrders: TemplatePage,
//   InactiveOrders: TemplatePage,
//   NoteTemplates: TemplatePage,
//   InProgressNotes: TemplatePage,
//   TemplatePage,
// };
